...
export const missileWeaponIconUrl = new URL("../../assets/ui/missile.png", import.meta.url).href;
...
export const vehicleHelicopterIconUrl = new URL(
...
export const reticleRocketAssetUrl = new URL("../../assets/ui/reticle_rocket.png", import.meta.url).href;
...
export const tankCannonSoundAssetUrl = new URL("../../assets/sounds/tank_cannon.wav", import.meta.url).href;
export const tankGunSoundAssetUrl = new URL("../../assets/sounds/tank_gun.mp3", import.meta.url).href;
export const missile1SoundAssetUrl = new URL("../../assets/sounds/missile_1.wav", import.meta.url).href;
...
export const armoredCarGunSoundAssetUrl = new URL(
  "../../assets/sounds/armoredcar_gun.wav",
  import.meta.url
).href;
...
export const jetGunSoundAssetUrl = new URL("../../assets/sounds/jet_gun.wav", import.meta.url).href;
export const helicopterBladesSoundAssetUrl = new URL(
  "../../assets/sounds/helicopter_blades.wav",
  import.meta.url
).href;
export const helicopterGunSoundAssetUrl = new URL(
